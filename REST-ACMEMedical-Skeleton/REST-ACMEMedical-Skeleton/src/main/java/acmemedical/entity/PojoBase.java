...
//DONE PB01 - Add annotation to define this class as superclass of all entities.  Please see Week 9 lecture slides.
//DONE PB02 - Add annotation to place all JPA annotations on fields.
//DONE PB03 - Add annotation for listener class.
@MappedSuperclass
...
public abstract class PojoBase implements Serializable {
	...
	// DONE PB06 - Add missing annotations (hint, is this column on DB?).
	@Column(name = "created")
