...
//DONE DS01 - This class is not an entity however it can be embedded in other entities.  Add missing annotation.
@Embeddable
public class DurationAndStatus implements Serializable {
	private static final long serialVersionUID = 1L;

	// DONE DS02 - Add annotations
	@Column(name = "start_date", nullable = false)
	private LocalDateTime startDate;
	
	// DONE DS03 - Add annotations
	@Column(name = "end_date", nullable = false)
	private LocalDateTime endDate;

	// DONE DS04 - Add annotations
